...
export const BAND_TOPICS: Record<number, Topic[]> = {
  0: [
    { id: '0-1', band: 0, order: 1, title: 'Nhập môn', description: 'Chào hỏi và số đếm cơ bản', icon: 'Star', type: 'vocabulary' },
    { id: 'g-0', band: 0, order: 2, title: 'To be & Đại từ', description: 'Trạm Ngữ pháp 1', icon: 'Book', type: 'grammar' },
    { id: '0-2', band: 0, order: 3, title: 'Động từ', description: 'Hành động cơ bản hàng ngày', icon: 'Activity', type: 'vocabulary' },
    { id: 'g-1', band: 0, order: 4, title: 'Hiện tại đơn', description: 'Trạm Ngữ pháp 2', icon: 'Feather', type: 'grammar' },
    { id: '0-3', band: 0, order: 5, title: 'Gia đình', description: 'Thành viên trong gia đình', icon: 'Users', type: 'vocabulary' },
    { id: '0-4', band: 0, order: 6, title: 'Đồ vật', description: 'Các vật dụng xung quanh', icon: 'Coffee', type: 'vocabulary' },
  ],
  1: [
    ...
    { id: '1-5', band: 1, order: 7, title: 'Cảm xúc', description: 'Diễn tả cảm xúc', icon: 'Heart', type: 'vocabulary' },
    { id: '1-6', band: 1, order: 8, title: 'Nhà cửa', description: 'Phòng & đồ đạc', icon: 'Home', type: 'vocabulary' },
    { id: '1-7', band: 1, order: 9, title: 'Tính từ', description: 'Miêu tả cơ bản', icon: 'Star', type: 'vocabulary' },
    { id: '1-8', band: 1, order: 10, title: 'Giáo dục', description: 'Trường học & học tập', icon: 'BookOpen', type: 'vocabulary' },
  ],
  2: [
    ...
    { id: '2-5', band: 2, order: 7, title: 'Sức khỏe', description: 'Thể chất & thể thao', icon: 'Activity', type: 'vocabulary' },
    { id: '2-6', band: 2, order: 8, title: 'Mua sắm', description: 'Cửa hàng & giá cả', icon: 'Trophy', type: 'vocabulary' },
  ],
  3: [
    ...
    { id: '3-2', band: 3, order: 3, title: 'Sức khỏe', description: 'Y tế & bệnh tật', icon: 'Activity', type: 'vocabulary' },
    ...
    { id: '3-5', band: 3, order: 7, title: 'Giải trí', description: 'Phim ảnh & âm nhạc', icon: 'Play', type: 'vocabulary' },
    { id: '3-6', band: 3, order: 8, title: 'Đô thị', description: 'Thành phố & cuộc sống', icon: 'Home', type: 'vocabulary' },
  ],
  4: [
    ...
    { id: '4-5', band: 4, order: 7, title: 'Truyền thông', description: 'Báo chí & tin tức', icon: 'MessageSquare', type: 'vocabulary' },
  ],
  5: [
    ...
    { id: '5-5', band: 5, order: 8, title: 'Chính trị', description: 'Chính phủ & quyền lực', icon: 'ShieldCheck', type: 'vocabulary' },
  ],
  6: [
    ...
    { id: '6-5', band: 6, order: 8, title: 'Nghệ thuật', description: 'Hội họa & điêu khắc', icon: 'Star', type: 'vocabulary' },
  ],
  7: [
    ...
    { id: '7-5', band: 7, order: 7, title: 'Học thuật', description: 'Nghiên cứu & phân tích', icon: 'Microscope', type: 'vocabulary' },
  ],
};
